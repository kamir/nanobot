...
# GoMikroBot installer — downloads the correct binary from GitHub Releases.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/kamir/nanobot/main/gomikrobot/scripts/install.sh | bash
#   curl -fsSL https://raw.githubusercontent.com/kamir/nanobot/main/gomikrobot/scripts/install.sh | bash -s -- v2.6.0
...
case "$OS" in
  ...
  *)
    ...
    echo "GoMikroBot supports macOS (darwin) and Linux." >&2
    exit 1
    ;;
esac
...
echo "Installing gomikrobot ${VERSION_DISPLAY} (${OS}/${ARCH})..."
